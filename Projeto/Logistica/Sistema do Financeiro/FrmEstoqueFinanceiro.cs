    ...
    public partial class FrmEstoqueFinanceiro : Form
    {
        ...
        private void btnImprimir_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                ReportDataSource estoqueFinanceiro = new ReportDataSource();
                ...
                estoqueFinanceiro.Name = "DsMadeiraFinanceiro";
                estoqueFinanceiro.Value = lst;
                #endregion

                FrmImpressaoEstoqueFinanceiro frmImpressao = new FrmImpressaoEstoqueFinanceiro(dtpDataPedido.Value, estoqueFinanceiro);
                frmImpressao.rvFinanceiro.LocalReport.DataSources.Clear();
                frmImpressao.rvFinanceiro.LocalReport.DataSources.Add(estoqueFinanceiro);
                frmImpressao.rvFinanceiro.LocalReport.ReportEmbeddedResource = "Projeto.Logistica.Sistema_do_Financeiro.Report1.rdlc";
