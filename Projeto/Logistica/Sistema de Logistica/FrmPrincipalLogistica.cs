...
=======
        ...
        private void txtAreaVerniz_TextChanged_1(object sender, EventArgs e)
        {
            CalcularVerniz();
        }
        ...
        private void txtAreaBase_TextChanged_1(object sender, EventArgs e)
        {
            CalcularVerniz();
        }
        ...
        private void txtAreaCetol_TextChanged_1(object sender, EventArgs e)
        {
            CalcularCetol();
        }
        private void txtRendimentoCetol_TextChanged_1(object sender, EventArgs e)
        {
            CalcularCetol();
        }
        private void txtAreaTerreo_TextChanged_1(object sender, EventArgs e)
        {
            CalcularWakol();
        }
        private void txtWakolTerreo_TextChanged_1(object sender, EventArgs e)
        {
            CalcularWakol();
        }
        private void txtAreaSuperior_TextChanged_1(object sender, EventArgs e)
        {
            CalcularWakol();
        }
        private void txtWakolSuperior_TextChanged_1(object sender, EventArgs e)
        {
            CalcularWakol();
        }
        ...
        private void CalcularVerniz()
        {
            try
            {
                ...
                txtGalaoBase.Text = totalbase.ToString("N2");
                #endregion
        ...
        private void CalcuparPresilha()
        {
            ...
            {                  
                ...
                txtPedidoPresilhas.Text = totalpresilha.ToString("N2");
                #endregion
        ...
        private void dgvPrincipal_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                FrmProposta frmproposta = new FrmProposta();
        ...
        private void dgvFerramenta_CellDoubleClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                ferra.FerramentaId = Convert.ToInt32(dgvFerramenta.Rows[e.RowIndex].Cells[0].Value);
        ...
        {
            for (int i = 0; i < dgvFerramenta.Rows.Count; i++)
            {
                var valor = Convert.ToString(dgvFerramenta.Rows[i].Cells[7].Value);
                switch (valor)
                {
                    case "Pendente": dgvFerramenta.Rows[i].DefaultCellStyle.BackColor = Color.Yellow; break;
                    case "Finalizado": dgvFerramenta.Rows[i].DefaultCellStyle.BackColor = Color.LightGreen; break;
                }
            }
