...
namespace Projeto.Util.Botao
{
    ...
    #region iTalk_DateTimePicker

    [DefaultEvent("TextChanged")]
    class iTalk_DateTimePicker : Control
    {
        #region Variables

        public DateTimePicker iTalkTDTP = new DateTimePicker();
        private GraphicsPath Shape1;
        private int _maxchars1 = 32767;
        private bool _Multiline1;
        private HorizontalAlignment ALNType1;
        private Pen P11;
        private SolidBrush B11;
        ...
        protected override void OnResize(EventArgs e)
        {
            ...
            if (_Multiline1)
            {
                iTalkTDTP.Height = Height - 10;
            }
            else
            {
                Height = iTalkTDTP.Height + 10;
            }

            Shape1 = new GraphicsPath();
            var _with1 = Shape1;
        ...
        public void AddTextBox()
        {
            ...
            //_TB.st .BorderStyle = BorderStyle.None;
            _TB.Font = new Font("Tahoma", 11);
            iTalkTDTP.KeyDown += _OnKeyDown;
            iTalkTDTP.TextChanged += OnBaseTextChanged;
        }

        public iTalk_DateTimePicker()
        {
            SetStyle(ControlStyles.SupportsTransparentBackColor, true);
            SetStyle(ControlStyles.UserPaint, true);

            Controls.Add(iTalkTDTP);

            P11 = new Pen(Color.FromArgb(180, 180, 180)); // P1 = Border color
            B11 = new SolidBrush(Color.White); // B1 = Rect Background color
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            G.FillPath(B11, Shape1); // Draw background
            G.DrawPath(P11, Shape1); // Draw border
    ...
    public class MyDateTimePicker : DateTimePicker
    {
        ...
        private void measureButtonWidth()
        {
            ...
            {
                var renderer = new System.Windows.Forms.VisualStyles.VisualStyleRenderer("DATEPICKER", 3, 1);
                using (var gr = CreateGraphics())
                {
                    buttonWidth = renderer.GetPartSize(gr, System.Windows.Forms.VisualStyles.ThemeSizeType.True).Height;
                }
            }
        }
    ...
    class iTalk_Button_1 : Control
    {
        ...
        public bool Enabled
        {
            ...
            set
            {
                if (value)
                {
                    _TextColor = Color.Black;// Color.FromArgb(150, 150, 150);
                }
                else
                {
                    _TextColor = Color.FromArgb(150, 150, 150);
                }
